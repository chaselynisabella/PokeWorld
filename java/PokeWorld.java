 ...
 *
 * @author Sundeep, Ethan Shernan, Heather, cbaca3
 * @version 1.0
 */
    ...
    private class ClickListener extends MouseAdapter {
        public void mousePressed(MouseEvent e) {
            ...
            if (types.size() < 1100) {
                ...
                // TODO
                // uncomment the last else-if below
                // and replace the "Pokemon1" with
                // your actual species name. Don't forget to
                ...
                }  else if (pokemonSpecies.equals("Ampharos")) {
                    types.add(new Ampharos(p.x, p.y, bounds));
                }
            }
